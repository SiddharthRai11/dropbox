...
export default function SignUpForm() {
    ...
    return (
      <Card className="w-full max-w-md border border-gray-200 bg-white shadow-xl rounded-2xl">
        <CardHeader className="flex flex-col gap-1 items-center pb-2">
          <h1 className="text-2xl font-extrabold text-blue-600 mb-1">Verify Your Email</h1>
        ...
        <CardBody className="py-8">
          ...
          <form onSubmit={handleVerificationSubmit} className="space-y-6">
            ...
            <Button type="submit" color="primary" className="w-full rounded-full shadow-md hover:shadow-lg transition-all duration-200" isLoading={isSubmitting}>
  ...
  return (
    <Card className="w-full max-w-md border border-gray-200 bg-white shadow-xl rounded-2xl">
      <CardHeader className="flex flex-col gap-1 items-center pb-2">
        <h1 className="text-2xl font-extrabold text-blue-600 mb-1">Create Your Account</h1>
        <p className="text-gray-500 text-center">
      ...
      <CardBody className="py-8">
        ...
        <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
          ...
          <div className="space-y-2">
            <label htmlFor="passwordConfirmation" className="text-sm font-semibold text-gray-900">
              Confirm Password
            </label>
            <Input
